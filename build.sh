...
qbuild --strict --verbose --exclude ".git" --exclude ".gitignore" --exclude ".gitkeep" --exclude "build" --exclude ".DS_Store" --exclude "icons/QMaven.pxm" --exclude "icons/source-image.png"
